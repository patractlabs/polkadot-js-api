...
import type { MemberRole, Url } from '@polkadot/types/interfaces/alliance';
...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    alliance: {
       ...
       **/
      accountBlacklist: AugmentedQuery<ApiType, () => Observable<Vec<AccountId>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * The current IPFS cids of the announcements.
       **/
      announcements: AugmentedQuery<ApiType, () => Observable<Vec<Cid>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      depositOf: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<Option<BalanceOf>>, [AccountId]> & QueryableStorageEntry<ApiType, [AccountId]>;
      /**
       * The members are being kicked out. They can't retire during the motion.
       **/
      kickingMembers: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<bool>, [AccountId]> & QueryableStorageEntry<ApiType, [AccountId]>;
      /**
       ...
       **/
      members: AugmentedQuery<ApiType, (arg: MemberRole | 'Founder' | 'Fellow' | 'Ally' | number | Uint8Array) => Observable<Vec<AccountId>>, [MemberRole]> & QueryableStorageEntry<ApiType, [MemberRole]>;
      /**
       ...
       **/
      rule: AugmentedQuery<ApiType, () => Observable<Option<Cid>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * The current blacklist of websites.
       **/
      websiteBlacklist: AugmentedQuery<ApiType, () => Observable<Vec<Url>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
