...
import { InkConstructorSpec, InkContractSpec, InkEventParamSpec, InkEventSpec, InkLayoutCell, InkLayoutField, InkLayoutKey, InkLayoutRange, InkLayoutStruct, InkMessageParamSpec, InkMessageSpec, InkProject, InkSelector, InkStorageLayout, InkTypeSpec, MtField, MtLookupTextId, MtLookupTypeId, MtRegistry, MtType, MtTypeDef, MtTypeDefArray, MtTypeDefComposite, MtTypeDefPrimitive, MtTypeDefSlice, MtTypeDefTuple, MtTypeDefVariant, MtVariant } from '@polkadot/types/interfaces/contractsAbi';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    MtLookupTextId: MtLookupTextId;
    'Compact<MtLookupTextId>': Compact<MtLookupTextId>;
    'Option<MtLookupTextId>': Option<MtLookupTextId>;
    'Vec<MtLookupTextId>': Vec<MtLookupTextId>;
    MtField: MtField;
