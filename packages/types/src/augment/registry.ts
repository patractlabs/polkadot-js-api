...
import { InkArrayLayout, InkCellLayout, InkConstructorSpec, InkContractSpec, InkCryptoHasher, InkDiscriminant, InkDisplayName, InkEnumLayout, InkEventParamSpec, InkEventSpec, InkFieldLayout, InkHashLayout, InkHashingStrategy, InkLayoutKey, InkMessageParamSpec, InkMessageSpec, InkProject, InkReturnTypeSpec, InkSelector, InkStorageLayout, InkStructLayout, InkTypeSpec, MtField, MtLookupTypeId, MtRegistry, MtType, MtTypeDef, MtTypeDefArray, MtTypeDefComposite, MtTypeDefPrimitive, MtTypeDefSequence, MtTypeDefTuple, MtTypeDefVariant, MtVariant } from '@polkadot/types/interfaces/contractsAbi';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    InkHashingStrategy: InkHashingStrategy;
    'Option<InkHashingStrategy>': Option<InkHashingStrategy>;
    'Vec<InkHashingStrategy>': Vec<InkHashingStrategy>;
    ...
    InkFieldLayout: InkFieldLayout;
    'Option<InkFieldLayout>': Option<InkFieldLayout>;
    'Vec<InkFieldLayout>': Vec<InkFieldLayout>;
    InkCellLayout: InkCellLayout;
    'Option<InkCellLayout>': Option<InkCellLayout>;
    'Vec<InkCellLayout>': Vec<InkCellLayout>;
    InkHashLayout: InkHashLayout;
    'Option<InkHashLayout>': Option<InkHashLayout>;
    'Vec<InkHashLayout>': Vec<InkHashLayout>;
    InkArrayLayout: InkArrayLayout;
    'Option<InkArrayLayout>': Option<InkArrayLayout>;
    'Vec<InkArrayLayout>': Vec<InkArrayLayout>;
    InkStructLayout: InkStructLayout;
    'Option<InkStructLayout>': Option<InkStructLayout>;
    'Vec<InkStructLayout>': Vec<InkStructLayout>;
    InkEnumLayout: InkEnumLayout;
    'Option<InkEnumLayout>': Option<InkEnumLayout>;
    'Vec<InkEnumLayout>': Vec<InkEnumLayout>;
    ...
    InkReturnTypeSpec: InkReturnTypeSpec;
    'Option<InkReturnTypeSpec>': Option<InkReturnTypeSpec>;
    'Vec<InkReturnTypeSpec>': Vec<InkReturnTypeSpec>;
